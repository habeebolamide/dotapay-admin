    ...
    <Form {...form}>
      ...
      >
        <div className="text-center space-y-1 pb-3">
          <h1 className="text-2xl font-semibold tracking-tight font-rebond">Get started with Dotapay</h1>
          <p className="text-sm text-muted-foreground font-rebond">
            Welcome to Dotapay, you are on the way to moving your business kindly continue with the following
          </p>
        </div>
