...
import { RequireActiveBusiness } from '@/auth/require-active-business';
...
import { SettlementBanksPage } from '@/pages/settlement-banks';
import { ReversalsPage } from '@/pages/reversals';
import { TransactionSplitsPage } from '@/pages/transaction-splits';
...
import { BusinessOnboardingPage } from '@/pages/businesses';
import { SettlementsTab } from '@/pages/settlement-banks/settlements-tab';
import { AutoSettlementDetailPage } from '@/pages/autosettlement-list/autosettlement-details-page';
import { WebhooksPage } from '@/pages/webhooks/webhooks-page';
import { WebhookLogsPage } from '@/pages/webhooks/components/webhook-log';
  ...
  return (
    <Routes>
      <Route element={<RequireAuth />}>
        <Route path="/businesses" element={<BusinessOnboardingPage />} />
        <Route element={<RequireActiveBusiness />}>
          ...
          />
          <Route element={<RequirePermission permission="tenant.payment.list" />}>
            <Route path="/transactions" element={<TransactionsPage />} />
          </Route>
          <Route element={<RequirePermission anyOf={['tenant.customers.index', 'tenant.customers.show']} />}>
            <Route path="/customers" element={<CustomersPage />} />
            <Route path="/customers/:customerId" element={<CustomerDetailPage />} />
          </Route>
          <Route element={<RequirePermission permission="tenant.businesses.wallets.list" />}>
            <Route path="/wallets" element={<WalletsPage />} />
            <Route path="/wallets/:walletSlug" element={<WalletDetailPage />} />
          </Route>
          <Route element={<RequirePermission permission="tenant.settlement-banks.index" />}>
            <Route path="/settlement-banks" element={<SettlementsTab />} />
            {/* <Route path="/settlement-banks" element={<SettlementBanksPage />} /> */}
            <Route path="/settlement-banks/:id" element={<SettlementBankDetailPage />} />
          </Route>
          <Route element={<RequirePermission permission="tenant.auto-settlements.store" />}>
            <Route path="/auto-settlement/:id" element={<AutoSettlementDetailPage />} />
          </Route>
          <Route element={<RequirePermission permission="tenant.split-groups.index" />}>
            <Route path="/transaction-splits" element={<TransactionSplitsPage />} />
          </Route>
          <Route element={<RequirePermission permission="tenant.settlements.index" />}>
            <Route path="/withdrawals" element={<WithdrawalsPage />} />
          </Route>
          <Route element={<RequirePermission permission="tenant.settings.getProfile" />}>
            <Route path="/settings" element={<SettingsPage />} />
          </Route>
          <Route element={<RequirePermission permission="tenant.webhooks.index" />}>
            <Route path="/webhooks" element={<WebhooksPage />} />
            <Route path="/webhooks/log/:id" element={<WebhookLogsPage />} />
          </Route>
          <Route>
            <Route path="/payment-analytics" element={<PaymentAnalyticsDashboard/>} />
          </Route>
          <Route element={<RequirePermission permission="tenant.compliance.getComplianceDetails" />}>
            <Route path="/compliance" element={<CompliancePage />} />
          </Route>
          <Route element={<RequirePermission permission="tenant.rbac.roles.index" />}>
            <Route
              path="/team"
              element={<AccountTeamMembersPage />}
            />
